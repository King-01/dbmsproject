...
<body><!-- Header -->
  ...
  <h3>View Bank Voucher by Schedule</h3>
  ...
  <form:form action="${pageContext.request.contextPath}/view/bankvoucherbetweendatesbyschedule" 
  ...
  <h4><c:if test="${ id != null }" >
   ...
   <c:if test = "${ status != null }" ><h4>
    ...
    <h4>List of Bank Vouchers are - </h4></c:if>
