...
<head>
	...
	<title>View Bank Voucher by account</title>
...
<body><!-- Header -->
	...
	<section id="main" class="wrapper">
		<div class="inner">
	<h1>View Bank Voucher by Account</h1>
	<form:form action="${pageContext.request.contextPath}/view/bankvoucherbyaccount" 
	...
	</c:if><h4>List of Bank Vouchers are - </h4>
