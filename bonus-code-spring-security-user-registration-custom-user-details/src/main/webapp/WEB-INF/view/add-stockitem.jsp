		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Create Stock Item</div>
				</div>

				<div style="padding-top: 30px" class="panel-body">

					<!-- Registration Form -->
					<form:form action="${pageContext.request.contextPath}/process/stockitem" 
						...
						<div style="margin-bottom: 25px" class="input-group">
							...
							<form:input path="stockItemName" placeholder="Stock item name (*)" class="form-control" />
						</div>
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
							Select Group for this account : <form:select path="groupId">
						...
						<div style="margin-bottom: 25px" class="input-group">
							...
							<form:input path="hsnGroup" placeholder="HSN Group " class="form-control" />
						</div>
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
							<form:errors path="mandiTax" cssClass="error alert alert-danger" />
							
							<form:input path="mandiTax" placeholder="Mandi Tax (*)(In percent) " class="form-control" />
						</div>
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
							<form:errors path="kkFee" cssClass="error alert alert-danger" />
							
							<form:input path="kkFee" placeholder="KK Fee (*)(In percent)" class="form-control" />
						</div>
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
							<form:errors path="labourCharge" cssClass="error alert alert-danger" />
							
							<form:input path="labourCharge" placeholder="labour Charge (*)(In percent)" class="form-control" />
						</div>
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
						...
						<div style="margin-bottom: 25px" class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> 
							<form:errors path="commision" cssClass="error alert alert-danger" />
							
							<form:input path="commision" placeholder="commision (*)(in percent)" class="form-control" />
						</div>
						<!-- Register Button -->
