...
<body>
  <h3>View Purchase Voucher by Schedule</h3>
  ...
  <form:form action="${pageContext.request.contextPath}/view/purchasebillvoucherbetweendatesbyschedule" 
  ...
  <h4><c:if test="${ id != null }" >
   ...
   <c:if test = "${ status != null }" ><h4>
    ...
    <h4>List of Purchase Vouchers are - </h4></c:if>
