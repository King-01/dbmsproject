...
<body><!-- Header -->
  ...
  <section id="main" class="wrapper">
    <div class="inner">
  <h1>View Journal Voucher by Schedule</h1>
  
   <form:form action="${pageContext.request.contextPath}/view/journalvoucherbetweendatesbyschedule" 
  ...
  <c:if test="${ (theList != null) && (theList.size() != 0)}">
