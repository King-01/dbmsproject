    ...
    <form:form action="${pageContext.request.contextPath}/update/account" 
        ...
        <h3>Enter new Account Name (*)- </h3>
           <form:errors path="accountName" cssClass="error alert alert-danger" />
            ...
            <form:input path="accountName" placeholder="Account Name (*)" class="form-control"/>
        <br>
        <form:hidden path="prev"/>
        <h3>Enter new Address Line1 (*)- </h3>
        <!-- Password -->
        ...
        <br>
        <h3>Enter new Guarantor Name (*) - </h3>
        <!-- Password -->
        <div style="margin-bottom: 25px" class="input-account">
        ...
        <br>
        <h3>Enter new Alternative Mobile Number - </h3>
        <!-- Password -->
        <div style="margin-bottom: 25px" class="input-account">
