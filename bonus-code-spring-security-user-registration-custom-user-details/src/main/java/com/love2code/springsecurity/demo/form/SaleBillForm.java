...
public class SaleBillForm {
    ...
    private List<StockSaleForm> theform;
    public List<StockSaleForm> getTheform() {
        return theform;
    }

    public void setTheform(List<StockSaleForm> theform) {
    ...
    public String toString() {
        return "SaleBillForm [date=" + date + ", cost=" + cost + ", accountId=" + accountId
